  ...
  public: {
    Tables: {
      ...
      lore_entries: {
        Row: {
          ...
          body: string | null;
          category: string;
          classification: Database["public"]["Enums"]["lore_classification"];
          clearance: Database["public"]["Enums"]["clearance_level"];
          cms_status: Database["public"]["Enums"]["cms_entry_status"];
          ...
          title: string;
          updated_at: string;
          visibility: Database["public"]["Enums"]["lore_visibility"];
        };
        Insert: {
          banner_image_url?: string | null;
          body?: string | null;
      ...
      lore_entry_versions: {
        ...
        Relationships: [
          {
            foreignKeyName: "lore_entry_versions_entry_id_fkey";
            columns: ["entry_id"];
            isOneToOne: false;
            referencedRelation: "lore_entries";
            referencedColumns: ["id"];
    ...
    Functions: {
      ...
      can_view_visibility: {
        Args: {
          _user_id: string;
          _visibility: Database["public"]["Enums"]["lore_visibility"];
        };
        Returns: boolean;
      };
    ...
    Enums: {
      app_role: "visitante" | "narrador" | "administrador" | "diretor" | "fundador";
      clearance_level:
        | "publico"
        | "nivel_1"
        | "nivel_2"
        ...
        | "verdade_absoluta"
        | "nivel_fundador";
      cms_entry_status: "draft" | "published" | "archived" | "obsolete" | "trash";
      ...
      gancho_status: "nao_iniciado" | "planejado" | "em_andamento" | "executado" | "arquivado";
      knowledge_scope: "players" | "uniao" | "diretores" | "curadores" | "staff_apenas";
      lore_category:
        | "universo"
        | "historia"
        | "npc"
        ...
        | "classe"
        | "ruptura";
      lore_classification: "publico" | "n_i" | "n_ii" | "n_iii" | "diretor";
      lore_visibility: "public" | "trivalente" | "instructor" | "director" | "council" | "founder";
      mystery_status: "sem_resposta" | "parcial" | "em_revelacao" | "resolvido" | "arquivado";
...
export const Constants = {
  public: {
    Enums: {
      ...
      mystery_status: ["sem_resposta", "parcial", "em_revelacao", "resolvido", "arquivado"],
      npc_status: ["ativo", "morto", "desaparecido", "oculto", "corrompido"],
      plot_status: ["rascunho", "planejado", "em_andamento", "executado", "arquivado", "cancelado"],
      ruptura_estado: ["aberta", "contida", "critica", "fechada"],
      threat_level: ["baixo", "medio", "alto", "critico", "catastrofico"],
      vestigio_estado: ["ativo", "morto", "instavel", "desaparecido"],
    },
